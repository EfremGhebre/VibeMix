...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "profile.loginRequiredDesc": "You need to be logged in to view your profile.",
    ...
    "profile.actionsTitle": "Account Actions",
    "profile.accountSettings": "Account Settings",
    "profile.signOut": "Sign Out",
    "favorites.title": "My Favorites",
    "favorites.loading": "Loading favorites...",
    "favorites.emptyTitle": "No favorites yet",
    "favorites.emptyDesc": "Save songs you love and they will appear here.",
    "favorites.discover": "Discover Music",
    "favorites.unknownSong": "Unknown Song",
    "favorites.unknownArtist": "Unknown Artist",
    "favorites.addToFavorites": "Add to favorites",
    "favorites.removeFromFavorites": "Remove from favorites",
    "favorites.savedTitle": "Added to favorites",
    "favorites.savedDesc": "This vibe is now in your favorites.",
    "favorites.removedTitle": "Removed from favorites",
    "favorites.removedDesc": "This vibe was removed from your favorites.",
    "favorites.searchPlaceholder": "Search favorites",
    "favorites.sortNewest": "Newest first",
    "favorites.sortOldest": "Oldest first",
    "favorites.sortTitle": "Title (A-Z)",
    "favorites.noResults": "No favorites match your search.",
    "theme.light": "Light",
    "theme.dark": "Dark",
    "theme.system": "System",
  ...
  ar: {
    ...
    "profile.hi": "مرحباً",
    "profile.loginRequired": "يرجى تسجيل الدخول",
    "profile.loginRequiredDesc": "يجب تسجيل الدخول لعرض ملفك الشخصي.",
    "profile.goHome": "العودة للرئيسية",
    ...
    "profile.actionsTitle": "إجراءات الحساب",
    "profile.accountSettings": "إعدادات الحساب",
    "profile.signOut": "تسجيل الخروج",
    "favorites.title": "المفضلة",
    "favorites.loading": "جاري تحميل المفضلة...",
    "favorites.emptyTitle": "لا توجد مفضلات بعد",
    "favorites.emptyDesc": "احفظ الأغاني التي تحبها وستظهر هنا.",
    "favorites.discover": "اكتشف الموسيقى",
    "favorites.unknownSong": "أغنية غير معروفة",
    "favorites.unknownArtist": "فنان غير معروف",
    "favorites.addToFavorites": "أضف إلى المفضلة",
    "favorites.removeFromFavorites": "إزالة من المفضلة",
    "favorites.savedTitle": "تمت الإضافة إلى المفضلة",
    "favorites.savedDesc": "هذا المزيج أصبح ضمن مفضلاتك.",
    "favorites.removedTitle": "تمت الإزالة من المفضلة",
    "favorites.removedDesc": "تمت إزالة هذا المزيج من مفضلاتك.",
    "favorites.searchPlaceholder": "ابحث في المفضلة",
    "favorites.sortNewest": "الأحدث أولاً",
    "favorites.sortOldest": "الأقدم أولاً",
    "favorites.sortTitle": "العنوان (أ-ي)",
    "favorites.noResults": "لا توجد نتائج مطابقة في المفضلة.",
    "theme.light": "فاتح",
    "theme.dark": "داكن",
    "theme.system": "النظام",
  ...
  sv: {
    ...
    "profile.hi": "Hej",
    "profile.loginRequired": "Logga in",
    "profile.loginRequiredDesc": "Du måste vara inloggad för att se din profil.",
    "profile.goHome": "Gå hem",
    "profile.loading": "Laddar profil...",
    "profile.infoTitle": "Profilinformation",
    ...
    "profile.actionsTitle": "Kontohandlingar",
    ...
    "favorites.emptyTitle": "Inga favoriter ännu",
    "favorites.emptyDesc": "Spara låtar du gillar så visas de här.",
    "favorites.discover": "Upptäck musik",
    "favorites.unknownSong": "Okänd låt",
    "favorites.unknownArtist": "Okänd artist",
    "favorites.addToFavorites": "Lägg till i favoriter",
    "favorites.removeFromFavorites": "Ta bort från favoriter",
    "favorites.savedTitle": "Tillagd i favoriter",
    "favorites.savedDesc": "Den här mixen finns nu i dina favoriter.",
    "favorites.removedTitle": "Borttagen från favoriter",
    "favorites.removedDesc": "Den här mixen har tagits bort från dina favoriter.",
    "favorites.searchPlaceholder": "Sök favoriter",
    "favorites.sortNewest": "Nyast först",
    "favorites.sortOldest": "Äldst först",
    "favorites.sortTitle": "Titel (A-Ö)",
    "favorites.noResults": "Inga favoriter matchar din sökning.",
    "theme.light": "Ljus",
    "theme.dark": "Mörk",
    "theme.system": "System",
