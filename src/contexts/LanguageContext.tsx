...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'app.description': 'VibeMix creates smart playlist recommendations based on how you feel and the languages you love, then lets you open them in your favorite music platform.',
    'hero.headline': 'Turn your mood into a ready-to-play mix',
    'hero.description': 'VibeMix creates smart playlist recommendations based on how you feel and the languages you love, then lets you open them in your favorite music platform.',
    ...
    'discover.subtitle': 'Select your mood, choose your music languages, and let VibeMix craft a personalized playlist you can open in any platform.',
    ...
    'features.multiLanguageDesc': 'Discover music in the languages you love — from English to Arabic, Swedish, Tigrinya, and more.',
    'features.platformFree': 'Any Platform',
    'features.platformFreeDesc': 'Open your mix in Spotify, Apple Music, or YouTube Music — no account connection needed.',
    ...
    'features.instantPlaylistDesc': 'Generate perfectly curated playlists in seconds based on your mood and preferred languages.',
    ...
    'howItWorks.step3Desc': 'VibeMix creates a curated playlist of 10-20 songs that match your mood and language preferences.',
    'howItWorks.step4': 'Listen Anywhere',
    'howItWorks.step4Desc': 'Open your mix in Spotify, Apple Music, or YouTube Music with one tap. No connection required.',
  },
  ar: {
    'app.name': 'VibeMix',
    'app.tagline': 'حوّل مزاجك إلى مزيج جاهز للاستماع',
    'app.description': 'VibeMix ينشئ توصيات ذكية لقوائم التشغيل بناءً على مشاعرك واللغات التي تحبها، ثم يتيح لك فتحها في منصة الموسيقى المفضلة لديك.',
    'hero.headline': 'حوّل مزاجك إلى مزيج جاهز للاستماع',
    'hero.description': 'VibeMix ينشئ توصيات ذكية لقوائم التشغيل بناءً على مشاعرك واللغات التي تحبها، ثم يتيح لك فتحها في منصة الموسيقى المفضلة لديك.',
    'hero.cta': 'ابدأ مزيجك',
    ...
    'genre.select': 'اختر الأنواع الموسيقية (اختياري)',
    ...
    'features.multiLanguageDesc': 'اكتشف الموسيقى باللغات التي تحبها — من العربية إلى الإنجليزية والسويدية والتيغرينية والمزيد.',
  ...
  sv: {
    ...
    'app.description': 'VibeMix skapar smarta spellisterekommendationer baserade på hur du mår och språken du älskar, och låter dig öppna dem i din favoritmusikplattform.',
    'hero.headline': 'Förvandla ditt humör till en spelklar mix',
    'hero.description': 'VibeMix skapar smarta spellisterekommendationer baserade på hur du mår och språken du älskar, och låter dig öppna dem i din favoritmusikplattform.',
    ...
    'discover.subtitle': 'Välj ditt humör, välj musikspråk, och låt VibeMix skapa en personlig spellista du kan öppna i valfri plattform.',
    ...
    'features.platformFreeDesc': 'Öppna din mix i Spotify, Apple Music eller YouTube Music — ingen kontokoppling behövs.',
    ...
    'features.instantPlaylistDesc': 'Generera kuraterade spellistor på sekunder baserat på ditt humör och föredragna språk.',
    ...
    'howItWorks.step3Desc': 'VibeMix skapar en kuraterad spellista med 10-20 låtar som matchar ditt humör och språkpreferenser.',
